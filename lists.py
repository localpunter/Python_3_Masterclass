# Lists
list1 = ["Alan", "Rachel", "Lego", 10, 10.5, -11]  # creating a list
...
# a_list[5:15]   slice starting at index 5 up to, but NOT including,
# index 15; so index 14 represents the last element in the slice
# a_list[5:]   slice starting at index 5 up to the end of the list
# slice starting at the beginning of the list up to, but NOT including,
# index 10
# a_list[:10]
...
# a_list[::2]   adds a third element called step; skips every second
# element of the list
